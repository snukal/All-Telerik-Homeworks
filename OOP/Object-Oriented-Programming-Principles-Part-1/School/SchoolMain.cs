...
namespace SchoolProblem
{
    ...
    public class SchoolMain
    {
        public static void Main()
        {
            ...
            Student firstStudent = new Student("Georgi Kolev", "This is the best school!");
            Student secondStudent = new Student("Elena Dragusheva", "11");
            Student thirdStudent = new Student("Valeriq Dimova", "My class is perfect!");

            Class schoolClass = new Class("Class Z", 
                new List<Student> { firstStudent, secondStudent, thirdStudent },
                new List<Teacher> { firstTeacher, secodTeacher, thirdTeacher }
                );

            school.AddingClass(schoolClass);
